...
import (
	...
	"github.com/tan-zhuo/huaweicloud-sdk-go-v3/services/imagesearch/v2/model"
)
...
func NewImageSearchClient(hcClient *httpclient.HcHttpClient) *ImageSearchClient {
	return &ImageSearchClient{HcClient: hcClient}
}

func ImageSearchClientBuilder() *httpclient.HcHttpClientBuilder {
