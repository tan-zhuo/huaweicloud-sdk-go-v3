...
func (o ShowRoutingBacklogPolicyResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowRoutingBacklogPolicyResponse struct{}"
	}

	return strings.Join([]string{"ShowRoutingBacklogPolicyResponse", string(data)}, " ")
}
