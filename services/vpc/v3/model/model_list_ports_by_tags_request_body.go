...
// ListPortsByTagsRequestBody This is a auto create Body Object
type ListPortsByTagsRequestBody struct {
...
func (o ListPortsByTagsRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListPortsByTagsRequestBody struct{}"
	}

	return strings.Join([]string{"ListPortsByTagsRequestBody", string(data)}, " ")
}
