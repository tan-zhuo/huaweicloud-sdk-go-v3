...
func (o FirewallInsertRuleItemOption) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "FirewallInsertRuleItemOption struct{}"
	}

	return strings.Join([]string{"FirewallInsertRuleItemOption", string(data)}, " ")
}
