...
// CountPortsByTagsRequestBody This is a auto create Body Object
type CountPortsByTagsRequestBody struct {
...
func (o CountPortsByTagsRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CountPortsByTagsRequestBody struct{}"
	}

	return strings.Join([]string{"CountPortsByTagsRequestBody", string(data)}, " ")
}
