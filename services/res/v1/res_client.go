...
import (
	...
	"github.com/tan-zhuo/huaweicloud-sdk-go-v3/services/res/v1/model"
)
...
func NewResClient(hcClient *httpclient.HcHttpClient) *ResClient {
	return &ResClient{HcClient: hcClient}
}

func ResClientBuilder() *httpclient.HcHttpClientBuilder {
